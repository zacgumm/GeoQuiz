...
public class CheatActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_ANSWER_IS_TRUE = "zacha.gumm.geoquiz.answer_is_true";
    private static final String EXTRA_ANSWER_SHOWN = "zacha.gumm.geoquiz.answer_shown";
